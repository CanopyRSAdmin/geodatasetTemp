...
if __name__ == '__main__':
    segmentations_path = '/media/CanopyRSAdmin/4 TB/XPrize/Data/SAM_segmentations_from_boxes/brazil_zf2/20240130_zf2quad_m3m_rgb_gr0p08_infersegmenteraggregator.gpkg'
    truth_boxes_path = '/media/CanopyRSAdmin/4 TB/XPrize/Data/raw/brazil_zf2/labels_species/20240130_zf2quad_m3m_rgb_labels_boxes_species.gpkg'
    iou_threshold = 0.20
    output_path = f'/media/CanopyRSAdmin/4 TB/XPrize/Data/SAM_segmentations_matched/20240130_zf2quad_m3m_rgb_SAMthreshold{str(iou_threshold).replace(".", "p")}_species.gpkg'
