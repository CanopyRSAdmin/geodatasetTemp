...
if __name__ == '__main__':
    main_coco_categories = json.load(open('/home/CanopyRSAdmin/PycharmProjects/geodataset/geodataset/utils/categories/brazil_zf2_trees/brazil_zf2_trees_categories.json'))['categories']
    additional_coco_categories = json.load(open('/home/CanopyRSAdmin/PycharmProjects/geodataset/geodataset/utils/categories/brazil_zf2_trees/brazil_zf2_trees_categories_fornewzf2dataonly.json'))['categories']
